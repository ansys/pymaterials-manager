...
- The supported material models can written to PyMAPDL / pyFluent / LS-Dyna
- The supported material models can be read from a MatML XML file
- The supported material models can be written to a MatML XML file
